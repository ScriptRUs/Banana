...
function library:NewWindow(name,theme)
local theme1
local theme2
local theme3
...
function InsideLibrary:NewTab(text)
...
function InsideTab:NewDropdown(text, list, callback)
    local BodyYSize = 0
...
function InsideTab:NewSlider(text, minvalue, maxvalue, callback)
    text = text or "Slider"
...
function InsideTab:NewToggle(text,callback)
...
function InsideTab:NewCheckbox(text,callback)
...
function InsideTab:NewButton(text, callback)
