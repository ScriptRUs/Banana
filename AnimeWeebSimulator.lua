...
--[ Please Don't Skid, This Took Hours On Days To Make For You Guys ]--
...
do -- Example UI
    ...
    do -- Elements
local Folder3 = Tab:AddFolder("Quests")
...
local function zone_check()
    ...
    for k in next, sex do rawset(sex, k, nil) end
        ...
        local Switch = Tab:AddSwitch("Teleport Farm", function(bool)
            if bool == true then
...
local train_switch = Tab:AddSwitch('No Teleport Train',function(v)
            if v == true then
            parse(ui_options.Stat)
            remote_fire()
            else
...
Tab:AddSwitch('Farm Chikara', function(val)
 ...
 Tab:AddSwitch('Players',function(v)
    ...
    elseif v == false then
        ...
        local Dropdown = Tab:AddDropdown("Select Stat", function(object)
        ...
        Tab3:AddLabel('This is coming soon, please wait longer!')
    end
    end
